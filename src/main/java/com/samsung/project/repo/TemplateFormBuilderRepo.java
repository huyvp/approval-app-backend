...
public interface TemplateFormBuilderRepo {
    ...
    public int insert(TemplateFromBuilder templateFromBuilder);
    ...
    public int update(TemplateFromBuilder templateFromBuilder);
    ...
    public List<TemplateFromBuilder> findById(int id);
